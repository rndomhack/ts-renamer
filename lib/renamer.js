...
class Renamer {
    ...
    getMacro() {
        ...
        return new Promise(resolve => {
            ...
            objMacro.title = Renamer.escape(program.title, true);
            objMacro.shortTitle = Renamer.escape(program.shortTitle, true) || Renamer.escape(program.title, true);
            objMacro.subTitle = program.subTitle === null ? "" : Renamer.escape(program.subTitle, true);

            objMacro.titleYomi = Renamer.escape(program.titleYomi, true);
            objMacro.titleEnglish = Renamer.escape(program.titleEnglish, true);
            ...
            objMacro.channelName = Renamer.escape(program.channelName, true);
            objMacro.channelUserName = program.channelUserName ? Renamer.escape(program.channelUserName, true) : "";
    ...
    makeFolder() {
        ...
        var folders = parsed.dir.replace(parsed.root, "").split(path.sep).filter(value => value !== "");
